...
; %bb.0:                                ; %entry
	...
	adrp	x19, lCPI214_0@PAGE
	adrp	x10, lCPI214_1@PAGE
	adrp	x28, lCPI214_2@PAGE
	adrp	x30, lCPI214_4@PAGE
	adrp	x6, lCPI214_5@PAGE
	adrp	x7, lCPI214_6@PAGE
	cmp	w14, #1                         ; =1
...
; %bb.1:                                ; %"for output.s0.y.y.preheader"
	...
	lsr	x16, x15, #1
	sub	w15, w3, #1                     ; =1
	str	w15, [sp, #560]                 ; 4-byte Folded Spill
	sxtw	x17, w1
	add	w1, w0, w14
	sxtw	x0, w0
	sub	w15, w11, w14
	...
	str	x4, [sp, #616]                  ; 8-byte Folded Spill
	add	x4, x21, x4, lsl #5
	add	x4, x4, #15                     ; =15
	str	x4, [sp, #528]                  ; 8-byte Folded Spill
	lsl	w4, w12, #5
	sub	w4, w4, #1                      ; =1
	str	w4, [sp, #512]                  ; 4-byte Folded Spill
	add	x4, x24, #16                    ; =16
	lsl	w26, w5, #1
	str	w26, [sp, #660]                 ; 4-byte Folded Spill
	add	w26, w26, w5
	str	w26, [sp, #656]                 ; 4-byte Folded Spill
	mov	w26, #18
	mov	w8, #18
	bfi	x8, x16, #6, #58
	...
	mov	w16, #18
	bfi	x16, x0, #7, #57
	str	x16, [sp, #424]                 ; 8-byte Folded Spill
	mov	w16, #18
	bfi	x16, x1, #5, #59
	str	x16, [sp, #400]                 ; 8-byte Folded Spill
	bfi	x26, x2, #6, #58
	str	x26, [sp, #488]                 ; 8-byte Folded Spill
	mov	w16, #1
	str	w16, [sp, #652]                 ; 4-byte Folded Spill
	ldr	q0, [x19, lCPI214_0@PAGEOFF]
	str	q0, [sp, #384]                  ; 16-byte Folded Spill
	sxtw	x16, w5
	sbfx	x26, x13, #5, #27
	ldr	q0, [x10, lCPI214_1@PAGEOFF]
	str	q0, [sp, #368]                  ; 16-byte Folded Spill
	ldr	q0, [x28, lCPI214_2@PAGEOFF]
	str	q0, [sp, #352]                  ; 16-byte Folded Spill
	sbfiz	x19, x14, #5, #32
	sxtw	x10, w12
	str	x10, [sp, #344]                 ; 8-byte Folded Spill
Lloh969:
	adrp	x10, lCPI214_3@PAGE
Lloh970:
	ldr	q0, [x10, lCPI214_3@PAGEOFF]
	str	q0, [sp, #320]                  ; 16-byte Folded Spill
	ldr	q0, [x30, lCPI214_4@PAGEOFF]
	str	q0, [sp, #304]                  ; 16-byte Folded Spill
	ldr	q0, [x6, lCPI214_5@PAGEOFF]
	str	q0, [sp, #288]                  ; 16-byte Folded Spill
	ldr	q0, [x7, lCPI214_6@PAGEOFF]
	str	q0, [sp, #272]                  ; 16-byte Folded Spill
Lloh971:
	adrp	x10, lCPI214_7@PAGE
Lloh972:
	ldr	q0, [x10, lCPI214_7@PAGEOFF]
	str	q0, [sp, #256]                  ; 16-byte Folded Spill
	sbfiz	x10, x3, #5, #32
	str	x10, [sp, #248]                 ; 8-byte Folded Spill
	movi.2d	v17, #0000000000000000
Lloh973:
	adrp	x10, lCPI214_8@PAGE
Lloh974:
	ldr	q0, [x10, lCPI214_8@PAGEOFF]
	sbfiz	x10, x11, #5, #32
	str	x10, [sp, #240]                 ; 8-byte Folded Spill
	smin.4s	v0, v0, v16
Lloh975:
	adrp	x10, lCPI214_9@PAGE
Lloh976:
	ldr	q1, [x10, lCPI214_9@PAGEOFF]
	smin.4s	v1, v1, v16
Lloh977:
	adrp	x10, lCPI214_10@PAGE
Lloh978:
	ldr	q2, [x10, lCPI214_10@PAGEOFF]
	bfi	x8, x26, #5, #59
...
Lloh988:
	...
	str	q16, [sp, #592]                 ; 16-byte Folded Spill
	smin.4s	v7, v7, v16
	mov	w8, w9
...
LBB214_2:                               ; %"for output.s0.y.y"
	...
	ldp	q17, q16, [sp, #368]            ; 32-byte Folded Reload
	ldr	q18, [sp, #352]                 ; 16-byte Folded Reload
	ldp	q20, q19, [sp, #304]            ; 32-byte Folded Reload
	ldp	q22, q21, [sp, #272]            ; 32-byte Folded Reload
...
LBB214_6:                               ; %after_bb
	...
	ldr	x5, [sp, #624]                  ; 8-byte Folded Reload
	ldr	w6, [sp, #560]                  ; 4-byte Folded Reload
	ldr	x7, [sp, #528]                  ; 8-byte Folded Reload
	ldr	w22, [sp, #512]                 ; 4-byte Folded Reload
...
; %bb.25:                               ; %"for output.s0.x.x.preheader"
	...
	dup.4s	v0, w8
	orr.16b	v0, v0, v22
	ldp	x14, x8, [sp, #240]             ; 16-byte Folded Reload
	add	x8, x1, x8
	ldp	x15, x13, [sp, #456]            ; 16-byte Folded Reload
	add	x13, x1, x13
	...
	add	x14, x1, x14
	add	x15, x1, x15
	ldp	x17, x16, [sp, #424]            ; 16-byte Folded Reload
	add	x16, x1, x16
	add	x17, x1, x17
...
LBB214_28:                              ; %call_destructor.exit
	...
	ldr	x5, [sp, #664]                  ; 8-byte Folded Reload
...
LBB214_30:                              ; %"end for output.s0.y.y.loopexit"
	...
	add	w10, w14, #7                    ; =7
	asr	w10, w10, #3
	adrp	x6, lCPI214_8@PAGE
	adrp	x7, lCPI214_3@PAGE
LBB214_31:                              ; %"end for output.s0.y.y"
	...
	csel	w12, w12, w17, gt
	cmp	w14, #1                         ; =1
	adrp	x3, lCPI214_11@PAGE
	adrp	x4, lCPI214_10@PAGE
	adrp	x2, lCPI214_9@PAGE
	adrp	x16, lCPI214_0@PAGE
	adrp	x0, lCPI214_1@PAGE
	adrp	x1, lCPI214_2@PAGE
	adrp	x25, lCPI214_4@PAGE
	adrp	x26, lCPI214_5@PAGE
	adrp	x30, lCPI214_6@PAGE
	b.lt	LBB214_61
...
Lloh990:
	...
	ldr	q2, [x4, lCPI214_10@PAGEOFF]
	add	x26, x24, #16                   ; =16
	ldr	q3, [x3, lCPI214_11@PAGEOFF]
	lsl	w8, w5, #1
Lloh991:
...
Lloh995:
	adrp	x11, lCPI214_14@PAGE
Lloh996:
	ldr	q6, [x11, lCPI214_14@PAGEOFF]
	mov	w8, #1
	str	w8, [sp, #652]                  ; 4-byte Folded Spill
	movi.2d	v17, #0000000000000000
	smin.4s	v0, v0, v16
	...
	smin.4s	v6, v6, v16
Lloh997:
	adrp	x11, lCPI214_15@PAGE
Lloh998:
	ldr	q7, [x11, lCPI214_15@PAGEOFF]
	str	q16, [sp, #592]                 ; 16-byte Folded Spill
	smin.4s	v7, v7, v16
	mov	w25, w9
	smax.4s	v0, v0, v17
...
LBB214_33:                              ; %"for output.s0.y.y31"
	...
	mov	x5, x27
	ldr	q7, [sp, #592]                  ; 16-byte Folded Reload
	ldp	q17, q16, [sp, #544]            ; 32-byte Folded Reload
	ldp	q19, q18, [sp, #512]            ; 32-byte Folded Reload
...
LBB214_37:                              ; %after_bb38
	...
	sub	w11, w9, #1                     ; =1
	subs	w14, w10, w9
	ldr	x4, [sp, #664]                  ; 8-byte Folded Reload
	ldr	x6, [sp, #624]                  ; 8-byte Folded Reload
	ldr	x7, [sp, #456]                  ; 8-byte Folded Reload
	ldr	w27, [sp, #424]                 ; 4-byte Folded Reload
	ldr	x30, [sp, #368]                 ; 8-byte Folded Reload
	ldp	q26, q25, [sp, #192]            ; 32-byte Folded Reload
	ldr	q27, [sp, #176]                 ; 16-byte Folded Reload
	ldp	q29, q28, [sp, #128]            ; 32-byte Folded Reload
	ldr	q30, [sp, #112]                 ; 16-byte Folded Reload
	ldp	q8, q31, [sp, #64]              ; 32-byte Folded Reload
	b.mi	LBB214_49
...
; %bb.46:                               ; %"for bounded_input.s0.x.x.rebased62.preheader"
                                        ;   in Loop: Header=BB214_39 Depth=2
	dup.4s	v0, w17
	ldr	w17, [sp, #672]                 ; 4-byte Folded Reload
	mov	x0, x16
	mov	x2, x19
...
; %bb.56:                               ; %"for output.s0.x.x88.preheader"
	...
	dup.4s	v0, w8
	orr.16b	v0, v0, v22
	ldp	x13, x8, [sp, #344]             ; 16-byte Folded Reload
	add	x8, x1, x8
	add	x13, x1, x13
	...
	add	x16, x1, x16
	ldp	x0, x17, [sp, #248]             ; 16-byte Folded Reload
	add	x17, x1, x17
	add	x0, x1, x0
...
LBB214_57:                              ; %"for output.s0.x.x88"
	...
	ushll.8h	v19, v24, #1
	uaba.8h	v22, v18, v21
	uaddl2.8h	v16, v6, v16
	add.8h	v16, v16, v19
	ushll.8h	v18, v25, #1
	uaddl2.8h	v17, v4, v17
	add.8h	v17, v17, v18
	sqxtun.8b	v18, v22
	uabd.8h	v16, v16, v17
	uaba.8h	v16, v23, v20
	...
	ldur	d28, [x5, #2]
	ushll.8h	v24, v24, #1
	uaddl.8h	v29, v25, v22
	ushll.8h	v26, v26, #1
	add.8h	v29, v29, v24
	uaddw.8h	v24, v26, v19
	ushll.8h	v26, v27, #1
	uaddl.8h	v27, v19, v22
	add.8h	v26, v27, v26
	ushll.8h	v27, v28, #1
	uaddw.8h	v24, v24, v7
	uaddl.8h	v28, v7, v25
	...
	ldur	d8, [x5, #10]
	ushll.8h	v27, v28, #1
	uaddl2.8h	v28, v25, v22
	add.8h	v28, v28, v27
	ushll.8h	v27, v30, #1
	uaba.8h	v26, v29, v24
	uaddl2.8h	v29, v7, v19
	add.8h	v27, v29, v27
	ushll.8h	v29, v31, #1
	uaddl2.8h	v22, v19, v22
	add.8h	v22, v22, v29
	sqxtun.8b	v26, v26
	ushll.8h	v29, v8, #1
	uaddl2.8h	v25, v7, v25
	add.8h	v25, v25, v29
	uabd.8h	v25, v22, v25
	uaba.8h	v25, v28, v27
	ldur	q22, [x7, #18]
	...
	add.8h	v29, v31, v29
	ushll.8h	v30, v30, #1
	uaddl.8h	v31, v22, v17
	ldur	d8, [x6, #25]
	add.8h	v30, v31, v30
	ldur	d31, [x7, #25]
	ldur	d10, [x5, #26]
	ushll.8h	v8, v8, #1
	uaddl2.8h	v11, v17, v18
	uabd.8h	v29, v29, v30
	add.8h	v30, v11, v8
	ushll.8h	v31, v31, #1
	uaddl2.8h	v8, v22, v5
	...
	ushll.8h	v8, v9, #1
	uaba.8h	v29, v25, v28
	uaddl2.8h	v18, v5, v18
	add.8h	v18, v18, v8
	ushll.8h	v25, v10, #1
	uaddl2.8h	v17, v22, v17
	add.8h	v17, v17, v25
	sqxtun.8b	v25, v29
	uabd.8h	v17, v18, v17
	uaba.8h	v17, v30, v31
	...
	ldur	d8, [x7, #2]
	ushll.8h	v29, v29, #1
	uaddw.8h	v29, v29, v26
	ushll.8h	v30, v30, #1
	uaddw.8h	v29, v29, v25
	uaddl.8h	v9, v26, v6
	add.8h	v30, v9, v30
	ushll.8h	v8, v8, #1
	uaddw.8h	v8, v8, v4
	...
	ldur	q19, [x5, #18]
	ushll.8h	v24, v24, #1
	uaddw.8h	v24, v24, v21
	ushll.8h	v27, v27, #1
	uaddl.8h	v31, v21, v26
	add.8h	v27, v31, v27
	uaddw.8h	v24, v24, v22
	ushll.8h	v28, v28, #1
	uaddw.8h	v28, v28, v25
	uaddw.8h	v28, v28, v22
	ldur	d31, [x5, #9]
	uabd.8h	v28, v27, v28
	ldur	d11, [x6, #10]
	ushll.8h	v27, v31, #1
	uaddl2.8h	v31, v22, v21
	add.8h	v27, v31, v27
	ushll.8h	v31, v10, #1
	uaba.8h	v28, v29, v24
	uaddl2.8h	v26, v21, v26
	add.8h	v29, v26, v31
	ushll.8h	v26, v11, #1
	uaddl2.8h	v25, v22, v25
	add.8h	v25, v25, v26
	sqxtun.8b	v26, v28
	uabd.8h	v25, v29, v25
	uaba.8h	v25, v8, v27
	...
	add.8h	v28, v31, v28
	ushll.8h	v29, v29, #1
	uaddl.8h	v31, v19, v17
	add.8h	v29, v31, v29
	ldur	d31, [x5, #25]
	uabd.8h	v29, v28, v29
	ldur	d10, [x6, #26]
	ushll.8h	v28, v31, #1
	uaddl2.8h	v31, v19, v5
	add.8h	v28, v31, v28
	ushll.8h	v31, v8, #1
	uaba.8h	v29, v30, v25
	uaddl2.8h	v18, v5, v18
	...
	ldur	d9, [x5, #2]
	ushll.8h	v30, v30, #1
	uaddw.8h	v30, v30, v29
	ushll.8h	v8, v8, #1
	uaddw.8h	v30, v30, v26
	uaddl.8h	v10, v29, v3
	add.8h	v8, v10, v8
	ushll.8h	v9, v9, #1
	uaddw.8h	v9, v9, v4
...
LBB214_59:                              ; %call_destructor.exit228
                                        ;   in Loop: Header=BB214_33 Depth=1
	ldr	x27, [sp, #632]                 ; 8-byte Folded Reload
	add	x27, x27, #1                    ; =1
	ldr	w8, [sp, #652]                  ; 4-byte Folded Reload
	sub	w8, w8, #8                      ; =8
	str	w8, [sp, #652]                  ; 4-byte Folded Spill
