...
DRAM_Type_Map = {
    ...
    "32768":'__dram_32768',
    "65536":'__dram_65536',
    "131072":'__dram_131072',
    "262144":'__dram_262144',
    "524288":'__dram_524288',
}
...
DRAMTypes = {
    ...
    '__dram_32': RoseBitVectorType.create(32),
    '__dram_64': RoseBitVectorType.create(64),
    '__dram_128': RoseBitVectorType.create(128),
    '__dram_256': RoseBitVectorType.create(256),
    '__dram_512': RoseBitVectorType.create(512),
    '__dram_1024': RoseBitVectorType.create(1024),
    '__dram_2048': RoseBitVectorType.create(2048),
    '__dram_4096': RoseBitVectorType.create(4098),
    '__dram_8192': RoseBitVectorType.create(8192),
    '__dram_16384': RoseBitVectorType.create(16384),
    '__dram_32768': RoseBitVectorType.create(32768),
    '__dram_65536': RoseBitVectorType.create(65536),
    '__dram_131072': RoseBitVectorType.create(131072),
    '__dram_262144': RoseBitVectorType.create(262144),
    '__dram_524288': RoseBitVectorType.create(524288),
