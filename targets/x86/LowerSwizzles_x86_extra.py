{
    ...
    " (x86_swizzle_499_dsl ; x86_swizzle_215\n\t(reg (bv 0 (bitvector 8))) ; < 32 x i8> False\n\t(reg (bv 1 (bitvector 8))) ; < 32 x i8> False\n\t128\n\t128\n\t0\n\t64\n\t16\n\t16\n\t64\n\t2\n\t0\n )_ (_mm_unpacklo_pi8_dsl ; _mm_unpacklo_pi8\n\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t (_mm256_unpackhi_epi16_dsl ; _mm256_unpackhi_epi16\n\t\t\t(reg (bv 0 (bitvector 8))) ; < 1 x i8> False\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 1 x i8> False\n\t\t\t256\n\t\t\t128\n\t\t\t0\n\t\t\t64\n\t\t\t16\n\t\t\t16\n\t\t\t2\n\t\t\t64\n\t\t\t0\n\t\t )\n\t\t128\n\t\t128\n\t\t0\n\t\t128\n\t\t32\n\t\t64\n\t\t1\n\t\t0\n\t )\n\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t (_mm256_unpackhi_epi16_dsl ; _mm256_unpackhi_epi16\n\t\t\t(reg (bv 2 (bitvector 8))) ; < 1 x i8> False\n\t\t\t(reg (bv 3 (bitvector 8))) ; < 1 x i8> False\n\t\t\t256\n\t\t\t128\n\t\t\t0\n\t\t\t64\n\t\t\t16\n\t\t\t16\n\t\t\t2\n\t\t\t64\n\t\t\t0\n\t\t )\n\t\t128\n\t\t128\n\t\t0\n\t\t128\n\t\t32\n\t\t64\n\t\t1\n\t\t0\n\t )\n\t64\n\t64\n\t0\n\t32\n\t8\n\t8\n\t2\n\t0\n\t0\n )": [
        {
            "property_name": "LowerSwizzles_filtered",
            "property": {
                "src": "(x86_swizzle_499_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 128 128 0 64 16 16 64 2 0)",
                "dst": "(_mm_unpacklo_pi8_dsl (_mm256_cvtepi64_epi32_dsl (_mm256_unpackhi_epi16_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 256 128 0 64 16 16 2 64 0) 128 128 0 128 16 32 1 0) (_mm256_cvtepi64_epi32_dsl (_mm256_unpackhi_epi16_dsl (reg (bv #x01 8)) (reg (bv #x01 8)) 256 128 0 64 8 8 2 64 0) 128 128 0 128 8 16 1 0) 128 128 0 64 16 16 2 0 0)"
            }
        }
    ],
    " (x86_swizzle_499_dsl ; x86_swizzle_215\n\t(reg (bv 0 (bitvector 8))) ; < 32 x i8> False\n\t(reg (bv 1 (bitvector 8))) ; < 32 x i8> False\n\t128\n\t128\n\t0\n\t64\n\t16\n\t16\n\t64\n\t2\n\t0\n )_ (_mm_unpacklo_pi8_dsl ; _mm_unpacklo_pi8\n\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t (_mm512_unpacklo_epi16_dsl ; _mm512_unpacklo_epi16\n\t\t\t(reg (bv 0 (bitvector 8))) ; < 1 x i8> False\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 1 x i8> False\n\t\t\t512\n\t\t\t128\n\t\t\t0\n\t\t\t64\n\t\t\t16\n\t\t\t16\n\t\t\t2\n\t\t\t0\n\t\t )\n\t\t128\n\t\t128\n\t\t0\n\t\t128\n\t\t32\n\t\t64\n\t\t1\n\t\t0\n\t )\n\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t (_mm512_unpacklo_epi16_dsl ; _mm512_unpacklo_epi16\n\t\t\t(reg (bv 2 (bitvector 8))) ; < 1 x i8> False\n\t\t\t(reg (bv 3 (bitvector 8))) ; < 1 x i8> False\n\t\t\t512\n\t\t\t128\n\t\t\t0\n\t\t\t64\n\t\t\t16\n\t\t\t16\n\t\t\t2\n\t\t\t0\n\t\t )\n\t\t128\n\t\t128\n\t\t0\n\t\t128\n\t\t32\n\t\t64\n\t\t1\n\t\t0\n\t )\n\t64\n\t64\n\t0\n\t32\n\t8\n\t8\n\t2\n\t0\n\t0\n )": [
        {
            "property_name": "LowerSwizzles_filtered",
            "property": {
                "src": "(x86_swizzle_499_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 128 128 0 64 8 8 128 2 0)",
                "dst": "(_mm_unpacklo_pi8_dsl (_mm256_cvtepi64_epi32_dsl (_mm512_unpacklo_epi16_dsl (reg (bv #x01 8)) (reg (bv #x01 8)) 256 128 0 64 32 32 2 0) 128 128 0 128 32 64 1 0) (_mm256_cvtepi64_epi32_dsl (_mm512_unpacklo_epi16_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 256 128 0 64 32 32 2 0) 128 128 0 128 32 64 1 0) 128 128 0 64 8 8 2 64 0)"
            }
        }
    ],
    " (x86_swizzle_499_dsl ; x86_swizzle_264\n\t(reg (bv 0 (bitvector 8))) ; < 32 x i8> False\n\t(reg (bv 1 (bitvector 8))) ; < 32 x i8> False\n\t64\n\t64\n\t0\n\t32\n\t16\n\t16\n\t32\n\t2\n\t0\n )_ (_m_from_int_dsl ; _m_from_int\n\t (_mm_unpacklo_pi8_dsl ; _mm_unpacklo_pi8\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 0 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t64\n\t\t64\n\t\t0\n\t\t32\n\t\t8\n\t\t8\n\t\t2\n\t\t0\n\t\t0\n\t )\n\t32\n\t32\n\t0\n\t32\n\t32\n\t0\n\t32\n )": [
        {
            "property_name": "LowerSwizzles_filtered",
            "property": {
                "src": "(x86_swizzle_499_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 64 64 0 32 16 16 128 2 0)",
    ...
    " (x86_swizzle_499_dsl ; x86_swizzle_650\n\t(reg (bv 0 (bitvector 8))) ; < 32 x i8> False\n\t(reg (bv 1 (bitvector 8))) ; < 32 x i8> False\n\t64\n\t64\n\t0\n\t32\n\t8\n\t8\n\t192\n\t2\n\t0\n )_ (_m_from_int_dsl ; _m_from_int\n\t (_mm_unpacklo_pi8_dsl ; _mm_unpacklo_pi8\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 0 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t64\n\t\t64\n\t\t0\n\t\t32\n\t\t8\n\t\t8\n\t\t2\n\t\t0\n\t\t0\n\t )\n\t32\n\t32\n\t0\n\t32\n\t32\n\t0\n\t32\n )": [
        {
            "property_name": "LowerSwizzles_filtered",
            "property": {
                "src": "(x86_swizzle_499_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 64 64 0 32 8 8 128 2 0)",
    ...
    " (x86_swizzle_499_dsl ; x86_swizzle_649\n\t(reg (bv 0 (bitvector 8))) ; < 32 x i8> False\n\t(reg (bv 1 (bitvector 8))) ; < 32 x i8> False\n\t64\n\t64\n\t0\n\t32\n\t8\n\t8\n\t224\n\t2\n\t0\n )_ (_m_from_int_dsl ; _m_from_int\n\t (_mm_unpacklo_pi8_dsl ; _mm_unpacklo_pi8\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 0 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t64\n\t\t64\n\t\t0\n\t\t32\n\t\t8\n\t\t8\n\t\t2\n\t\t0\n\t\t0\n\t )\n\t32\n\t32\n\t0\n\t32\n\t32\n\t0\n\t32\n )": [
        {
            "property_name": "LowerSwizzles_filtered",
            "property": {
                "src": "(x86_swizzle_499_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 64 64 0 32 8 8 128 2 0)",
                "dst": "(_m_from_int_dsl (_mm_unpacklo_pi8_dsl (_mm256_cvtepi64_epi32_dsl (reg (bv #x00 8)) 128 128 0 128 32 64 1 0) (_mm256_cvtepi64_epi32_dsl (reg (bv #x01 8)) 128 128 0 128 32 64 1 0) 128 128 0 64 8 8 2 64 0) 64 64 0 64 64 0 0)"
            }
        }
    ],
    " (x86_swizzle_499_dsl ; x86_swizzle_653\n\t(reg (bv 0 (bitvector 8))) ; < 32 x i8> False\n\t(reg (bv 1 (bitvector 8))) ; < 32 x i8> False\n\t64\n\t64\n\t0\n\t32\n\t8\n\t8\n\t96\n\t2\n\t0\n )_ (_m_from_int_dsl ; _m_from_int\n\t (_mm_unpacklo_pi8_dsl ; _mm_unpacklo_pi8\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 0 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t (_mm256_cvtepi64_epi32_dsl ; _mm256_cvtepi64_epi32\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 1 x i8> False\n\t\t\t128\n\t\t\t128\n\t\t\t0\n\t\t\t128\n\t\t\t32\n\t\t\t64\n\t\t\t1\n\t\t\t0\n\t\t )\n\t\t64\n\t\t64\n\t\t0\n\t\t32\n\t\t8\n\t\t8\n\t\t2\n\t\t0\n\t\t0\n\t )\n\t32\n\t32\n\t0\n\t32\n\t32\n\t0\n\t32\n )": [
        {
            "property_name": "LowerSwizzles_filtered",
            "property": {
                "src": "(x86_swizzle_499_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 64 64 0 32 8 8 128 2 0)",
