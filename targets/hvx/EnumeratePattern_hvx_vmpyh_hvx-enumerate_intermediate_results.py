    ...
    " (hvx_swizzle_1_dsl ; hvx_swizzle_1\n\t (hexagon_V6_vmpyh_128B_dsl ; hexagon_V6_vmpyh_128B\n\t\t(reg (bv 0 (bitvector 8))) ; < 128 x i8> False\n\t\t (hexagon_V6_interleave_2_128B_dsl ; hexagon_V6_interleave_2_128B\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 2 x i8> False\n\t\t\t16\n\t\t\t32\n\t\t )\n\t\t32\n\t\t32\n\t\t0\n\t\t512\n\t\t16\n\t\t0\n\t\t512\n\t\t16\n\t\t32\n\t\t1\n\t\t1\n\t\t1\n\t\t0\n\t\t32\n\t\t1024\n\t\t1\n\t\t1\n\t\t16\n\t\t16\n\t\t2\n\t\t0\n\t )\n\t2048\n\t64\n\t0\n\t64\n\t32\n\t32\n\t2\n\t0\n )+ (typed:signed-vec-widen-mul ; typed:signed-vec-widen-mul_p16_s1024_signed_1\n\t (typed:xBroadcast ; typed:xBroadcast_is16_os1024_signed_None\n\t\t(buffer-index  1 'uint8 16) ; < 2 x i8> False\n\t\t16\n\t\t16\n\t\t64\n\t )\n\t(buffer-index  0 'uint8 1024) ; < 128 x i8> False\n\t16\n\t1024\n )+2048+hvx_swizzle_1+typed:signed-vec-widen-mul_p16_s1024_signed_1": [
        {
            ...
            "property": {
                ...
                "output_size": 2048,
                "original_src_expr": " (hvx_swizzle_1_dsl ; hvx_swizzle_1\n\t (hexagon_V6_vmpyh_128B_dsl ; hexagon_V6_vmpyh_128B\n\t\t(reg (bv 0 (bitvector 8))) ; < 128 x i8> False\n\t\t (hexagon_V6_interleave_2_128B_dsl ; hexagon_V6_interleave_2_128B\n\t\t\t(reg (bv 1 (bitvector 8))) ; < 2 x i8> False\n\t\t\t16\n\t\t\t32\n\t\t )\n\t\t32\n\t\t32\n\t\t0\n\t\t512\n\t\t16\n\t\t0\n\t\t512\n\t\t16\n\t\t32\n\t\t1\n\t\t1\n\t\t1\n\t\t0\n\t\t32\n\t\t1024\n\t\t1\n\t\t1\n\t\t16\n\t\t16\n\t\t2\n\t\t0\n\t )\n\t2048\n\t64\n\t0\n\t64\n\t32\n\t32\n\t2\n\t0\n )",
                "original_dst_expr": " (typed:signed-vec-widen-mul ; typed:signed-vec-widen-mul_p16_s1024_signed_1\n\t (typed:xBroadcast ; typed:xBroadcast_is16_os1024_signed_None\n\t\t(buffer-index  1 'uint8 16) ; < 2 x i8> False\n\t\t16\n\t\t16\n\t\t64\n\t )\n\t(buffer-index  0 'uint8 1024) ; < 128 x i8> False\n\t16\n\t1024\n )",
                "src_ctx": "hvx_swizzle_1",
                "dst_ctx": "typed:signed-vec-widen-mul_p16_s1024_signed_1"
            }
        }
    ],
    " (hexagon_V6_vmpyh_128B_dsl ; hexagon_V6_vmpyuh_128B\n\t (hvx_swizzle_1_dsl ; hvx_swizzle_2\n\t\t(reg (bv 0 (bitvector 8))) ; < 128 x i8> False\n\t\t1024\n\t\t32\n\t\t0\n\t\t32\n\t\t16\n\t\t32\n\t\t2\n\t\t0\n\t )\n\t (hexagon_V6_interleave_2_128B_dsl ; hexagon_V6_interleave_2_128B\n\t\t(reg (bv 1 (bitvector 8))) ; < 2 x i8> False\n\t\t16\n\t\t32\n\t )\n\t32\n\t32\n\t0\n\t512\n\t16\n\t0\n\t512\n\t16\n\t32\n\t1\n\t0\n\t0\n\t0\n\t32\n\t1024\n\t0\n\t0\n\t16\n\t16\n\t2\n\t0\n )+ (typed:unsigned-vec-widen-mul ; typed:unsigned-vec-widen-mul_p16_s1024_signed_0\n\t (typed:xBroadcast ; typed:xBroadcast_is16_os1024_signed_None\n\t\t(buffer-index  1 'uint8 16) ; < 2 x i8> False\n\t\t16\n\t\t16\n\t\t64\n\t )\n\t(buffer-index  0 'uint8 1024) ; < 128 x i8> False\n\t16\n\t1024\n )+2048+hexagon_V6_vmpyuh_128B+typed:unsigned-vec-widen-mul_p16_s1024_signed_0": [
        {
            "property_name": "EnumeratePattern_hvx_vmpyh",
            "property": {
                ...
                "dst": "(typed:unsigned-vec-widen-mul (typed:xBroadcast (reg (bv #x01 8)) 16 16 64) (reg (bv #x00 8)) 16 1024)",
                "output_size": 2048,
                "original_src_expr": " (hexagon_V6_vmpyh_128B_dsl ; hexagon_V6_vmpyuh_128B\n\t (hvx_swizzle_1_dsl ; hvx_swizzle_2\n\t\t(reg (bv 0 (bitvector 8))) ; < 128 x i8> False\n\t\t1024\n\t\t32\n\t\t0\n\t\t32\n\t\t16\n\t\t32\n\t\t2\n\t\t0\n\t )\n\t (hexagon_V6_interleave_2_128B_dsl ; hexagon_V6_interleave_2_128B\n\t\t(reg (bv 1 (bitvector 8))) ; < 2 x i8> False\n\t\t16\n\t\t32\n\t )\n\t32\n\t32\n\t0\n\t512\n\t16\n\t0\n\t512\n\t16\n\t32\n\t1\n\t0\n\t0\n\t0\n\t32\n\t1024\n\t0\n\t0\n\t16\n\t16\n\t2\n\t0\n )",
                "original_dst_expr": " (typed:unsigned-vec-widen-mul ; typed:unsigned-vec-widen-mul_p16_s1024_signed_0\n\t (typed:xBroadcast ; typed:xBroadcast_is16_os1024_signed_None\n\t\t(buffer-index  1 'uint8 16) ; < 2 x i8> False\n\t\t16\n\t\t16\n\t\t64\n\t )\n\t(buffer-index  0 'uint8 1024) ; < 128 x i8> False\n\t16\n\t1024\n )",
                "src_ctx": "hexagon_V6_vmpyuh_128B",
                "dst_ctx": "typed:unsigned-vec-widen-mul_p16_s1024_signed_0"
            }
        }
    ],
    " (hexagon_V6_vmpyh_128B_dsl ; hexagon_V6_vmpyh_128B\n\t (hvx_swizzle_1_dsl ; hvx_swizzle_2\n\t\t(reg (bv 0 (bitvector 8))) ; < 128 x i8> False\n\t\t1024\n\t\t32\n\t\t0\n\t\t32\n\t\t16\n\t\t32\n\t\t2\n\t\t0\n\t )\n\t (hexagon_V6_interleave_2_128B_dsl ; hexagon_V6_interleave_2_128B\n\t\t(reg (bv 1 (bitvector 8))) ; < 2 x i8> False\n\t\t16\n\t\t32\n\t )\n\t32\n\t32\n\t0\n\t512\n\t16\n\t0\n\t512\n\t16\n\t32\n\t1\n\t1\n\t1\n\t0\n\t32\n\t1024\n\t1\n\t1\n\t16\n\t16\n\t2\n\t0\n )+ (typed:signed-vec-widen-mul ; typed:signed-vec-widen-mul_p16_s1024_signed_1\n\t (typed:xBroadcast ; typed:xBroadcast_is16_os1024_signed_None\n\t\t(buffer-index  1 'uint8 16) ; < 2 x i8> False\n\t\t16\n\t\t16\n\t\t64\n\t )\n\t(buffer-index  0 'uint8 1024) ; < 128 x i8> False\n\t16\n\t1024\n )+2048+hexagon_V6_vmpyh_128B+typed:signed-vec-widen-mul_p16_s1024_signed_1": [
        {
            "property_name": "EnumeratePattern_hvx_vmpyh",
            "property": {
                ...
                "dst": "(typed:signed-vec-widen-mul (typed:xBroadcast (reg (bv #x01 8)) 16 16 64) (reg (bv #x00 8)) 16 1024)",
                "output_size": 2048,
                "original_src_expr": " (hexagon_V6_vmpyh_128B_dsl ; hexagon_V6_vmpyh_128B\n\t (hvx_swizzle_1_dsl ; hvx_swizzle_2\n\t\t(reg (bv 0 (bitvector 8))) ; < 128 x i8> False\n\t\t1024\n\t\t32\n\t\t0\n\t\t32\n\t\t16\n\t\t32\n\t\t2\n\t\t0\n\t )\n\t (hexagon_V6_interleave_2_128B_dsl ; hexagon_V6_interleave_2_128B\n\t\t(reg (bv 1 (bitvector 8))) ; < 2 x i8> False\n\t\t16\n\t\t32\n\t )\n\t32\n\t32\n\t0\n\t512\n\t16\n\t0\n\t512\n\t16\n\t32\n\t1\n\t1\n\t1\n\t0\n\t32\n\t1024\n\t1\n\t1\n\t16\n\t16\n\t2\n\t0\n )",
                "original_dst_expr": " (typed:signed-vec-widen-mul ; typed:signed-vec-widen-mul_p16_s1024_signed_1\n\t (typed:xBroadcast ; typed:xBroadcast_is16_os1024_signed_None\n\t\t(buffer-index  1 'uint8 16) ; < 2 x i8> False\n\t\t16\n\t\t16\n\t\t64\n\t )\n\t(buffer-index  0 'uint8 1024) ; < 128 x i8> False\n\t16\n\t1024\n )",
                "src_ctx": "hexagon_V6_vmpyh_128B",
                "dst_ctx": "typed:signed-vec-widen-mul_p16_s1024_signed_1"
            }
        }
    ]
