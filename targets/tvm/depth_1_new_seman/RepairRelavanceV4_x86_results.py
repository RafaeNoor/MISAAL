x86_RepairRelavanceV4={
    ...
    "_mm_add_si64+typed-folded:vec-add": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-add_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 64 64 -1)",
    ...
    "_mm_broadcastmb_epi64+typed-folded:cast-extend": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:cast-extend_dsl (reg (bv #x00 8)) 16 16 32 0)",
    ...
    "_mm_hadd_pi32+typed-folded:vec-add": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-add_dsl (reg (bv #x02 8)) (reg (bv #x03 8)) 32 32 -1)",
    ...
    "_mm_hadd_pi32+typed-folded:vec-max": [
        {
            ...
            "property": {
                "candidate": "_mm_hadd_pi32",
                "output_expression": "(typed-folded:vec-max_dsl (reg (bv #x04 8)) (reg (bv #x04 8)) 16 32 1)",
                "synth_expression": "(_mm_hadd_pi32_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 32 32 0 32 32 -1 -1 0 32 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0))\n(define b (vector-ref env 1)) \n (define reg_0 (concat \n\n(extract 63 32 a)))\n(define reg_1 (concat \n\n(extract 31 0 a)))\n(define reg_2 (concat \n\n(extract 63 32 b)))\n(define reg_3 (concat \n\n(extract 31 0 b)))\n(define %2.ab0 (concat \n\n(bvaddnw (extract 63 32 a) (extract 31 0 a) 32 -1))) \n (vector reg_0 reg_1 reg_2 reg_3 %2.ab0)\n)",
                "target_input_sizes": [
                    32,
    ...
    "_mm_hadd_pi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                "candidate": "_mm_hadd_pi32",
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x04 8)) (reg (bv #x04 8)) 32 32)",
                "synth_expression": "(_mm_hadd_pi32_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 32 32 0 32 32 -1 -1 0 32 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0))\n(define b (vector-ref env 1)) \n (define reg_0 (concat \n\n(extract 63 32 a)))\n(define reg_1 (concat \n\n(extract 31 0 a)))\n(define reg_2 (concat \n\n(extract 63 32 b)))\n(define reg_3 (concat \n\n(extract 31 0 b)))\n(define %2.ab0 (concat \n\n(bvaddnw (extract 63 32 a) (extract 31 0 a) 32 -1))) \n (vector reg_0 reg_1 reg_2 reg_3 %2.ab0)\n)",
                "target_input_sizes": [
                    32,
    ...
    "_mm_add_pi8+typed-folded:vec-add": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-add_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 8 64 0)",
                "synth_expression": "(_mm_add_pi8_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 512 512 0 512 8 0 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0))\n(define b (vector-ref env 1)) \n (define reg_0 (concat \n\n(extract 511 448 a)))\n(define reg_1 (concat \n\n(extract 511 448 b))) \n (vector reg_0 reg_1)\n)",
                "target_input_sizes": [
                    64,
                    64
    ...
    "_mm_div_epi64+typed-folded:vec-div": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-div_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 16 64 0)",
    ...
    "_mm512_cvtepu8_epi32+typed-folded:cast-extend": [
        {
            "property_name": "RepairRelavanceV4",
            "property": {
                "candidate": "_mm512_cvtepu8_epi32",
                "output_expression": "(typed-folded:cast-extend_dsl (reg (bv #x00 8)) 16 32 32 1)",
                "synth_expression": "(_mm512_cvtepu8_epi32_dsl (reg (bv #x00 8)) 256 256 0 256 16 32 1 1 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0)) \n (define reg_0 (concat \n\n(extract 255 224 a))) \n (vector reg_0)\n)",
                "target_input_sizes": [
                    32
                ],
    ...
    "_mm256_ror_epi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x07 8)) (reg (bv #x04 8)) 8 64)",
    ...
    "_mm512_rem_epu32+typed-folded:vec-mod": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-mod_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 32 64 1)",
                "synth_expression": "(_mm512_rem_epu32_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 256 256 0 256 32 1 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0))\n(define b (vector-ref env 1)) \n (define reg_0 (concat \n\n(extract 255 192 a)))\n(define reg_1 (concat \n\n(extract 255 192 b))) \n (vector reg_0 reg_1)\n)",
                "target_input_sizes": [
                    64,
                    64
    ...
    "_mm512_or_epi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 64 64)",
    ...
    "_mm256_max_epu64+typed-folded:vec-max": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-max_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 16 64 1)",
                "synth_expression": "(_mm256_max_epu64_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 256 256 0 256 16 1 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0))\n(define b (vector-ref env 1)) \n (define reg_0 (concat \n\n(extract 255 192 a)))\n(define reg_1 (concat \n\n(extract 255 192 b))) \n (vector reg_0 reg_1)\n)",
                "target_input_sizes": [
                    64,
                    64
    ...
    "_mm_rorv_epi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x05 8)) (reg (bv #x03 8)) 16 64)",
    ...
    "_mm_min_epu16+typed-folded:vec-min": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-min_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 64 64 1)",
    ...
    "_mm512_subs_epi8+typed-folded:vec-sub": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-sub_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 32 64 -1)",
    ...
    "_m_por+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                "candidate": "_m_por",
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 16 512)",
