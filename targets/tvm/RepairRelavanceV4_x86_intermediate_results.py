    ...
    "_mm_add_pi8+typed-folded:vec-add": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-add_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 16 64 1)",
    ...
    "_mm_div_epi64+typed-folded:vec-div": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-div_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 8 64 1)",
                "synth_expression": "(_mm_div_epi64_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 128 128 0 128 8 1 1 16 1 16 0)",
    ...
    "_mm256_rol_epi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x04 8)) (reg (bv #x07 8)) 16 64)",
    ...
    "_mm512_rem_epu32+typed-folded:vec-mod": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-mod_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 16 64 1)",
    ...
    "_mm_rolv_epi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x05 8)) (reg (bv #x03 8)) 8 64)",
    ...
    "_mm256_max_epu64+typed-folded:vec-max": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-max_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 16 64 1)",
    ...
    "_mm_rorv_epi32+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x05 8)) (reg (bv #x03 8)) 64 64)",
    ...
    "_mm_hsub_pi32+typed-folded:vec-min": [
        {
            ...
            "property": {
                "candidate": "_mm_hsub_pi32",
                "output_expression": "(typed-folded:vec-min_dsl (reg (bv #x04 8)) (reg (bv #x04 8)) 16 32 1)",
    ...
    "_mm_sub_si64+typed-folded:vec-sub": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-sub_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 64 64 -1)",
    ...
    "_mm_min_epu16+typed-folded:vec-min": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-min_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 8 64 0)",
                "synth_expression": "(_mm_min_epu16_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 256 256 0 256 8 0 0)",
                "env-func": "(define (prepare-env env) \n\n(define a (vector-ref env 0))\n(define b (vector-ref env 1)) \n (define reg_0 (concat \n\n(extract 255 192 a)))\n(define reg_1 (concat \n\n(extract 255 192 b))) \n (vector reg_0 reg_1)\n)",
                "target_input_sizes": [
                    64,
                    64
    ...
    "_mm512_subs_epi8+typed-folded:vec-sub": [
        {
            ...
            "property": {
                ...
                "output_expression": "(typed-folded:vec-sub_dsl (reg (bv #x01 8)) (reg (bv #x00 8)) 8 64 1)",
    ...
    "_m_por+typed-folded:vec-bwor": [
        {
            ...
            "property": {
                "candidate": "_m_por",
                "output_expression": "(typed-folded:vec-bwor_dsl (reg (bv #x00 8)) (reg (bv #x01 8)) 32 512)",
