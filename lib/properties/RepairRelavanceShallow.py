...
# Fast version of repair relevance. Meant for testing expressions at depth 1. Essentially the way this property operates
class RepairRelavanceShallow(RepairRelavanceV4):
    ...
    def get_property_desc(self):
        return "Test if a given output dsl instruction may be used to generate target expression (Version Shallow)"
