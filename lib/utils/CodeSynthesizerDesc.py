...
TVM_X86_SYNTH_DESC = CodeSynthesizerDesc(target_name= "tvm",interpreter_name="typed:tvm:interpret", cost_name= "typed:tvm:cost", bind_name="tvm:bind-expr", printer_name="typed:tvm:hydride-printer", get_prec_name="typed:tvm:get-prec", get_length_name="typed:tvm:get-length", target_vector_sizes = [32, 64,128, 256, 512], visitor_name = "typed:tvm:visitor", get_ops_name = "typed:tvm:get-bv-ops" , sema_path = os.path.join(MISAAL_SRC,"/lib/sema/tvm_folded.py"), dict_name = "tvm_folded")
