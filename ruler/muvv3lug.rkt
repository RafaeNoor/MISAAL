...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvult 'if) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "ka6ubean.src.log.rkt")
(write-str-to-file (~v mat-dst) "ka6ubean.dst.log.rkt")
(exit 0)] [else (exit 1)])
