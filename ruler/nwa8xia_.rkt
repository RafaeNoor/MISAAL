...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvslt 'if) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "rdrl_hgm.src.log.rkt")
(write-str-to-file (~v mat-dst) "rdrl_hgm.dst.log.rkt")
(exit 0)] [else (exit 1)])
