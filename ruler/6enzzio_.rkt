...
(define (src_output_hexagon_V6_vminuh_128B_layer_0_bv_32) 
(choose* 
'()
)
)
(define src-expr
 (src_output_hexagon_V6_vminuh_128B_layer_0_bv_32)
)
(define (dst_output_typed:unsigned-vec-min_layer_0_bv_32) 
(choose* 
(typed:unsigned-vec-min	;typed:unsigned-vec-min_p16_s32_signed_0
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
16				;; Precision Operand 
32				;; Integer Operand 
)
(typed:unsigned-vec-min	;typed:unsigned-vec-min_p32_s32_signed_0
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
32				;; Precision Operand 
32				;; Integer Operand 
)
(typed:unsigned-vec-min	;typed:unsigned-vec-min_p8_s32_signed_0
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
8				;; Precision Operand 
32				;; Integer Operand 
...
(define leaves-sizes (list 32 32))
(define-values (satisfiable? mat-src mat-dst)  (expanded-grammar-synthesize invoke-spec invoke-spec-lane src-expr (dst_output_typed:unsigned-vec-min_layer_0_bv_32) leaves-sizes optimize? interpreter cost-model  symbolic? 30 'z3))
(cond [satisfiable? (write-str-to-file (~v mat-src) "lo2p0hsg.src.log.rkt")
(write-str-to-file (~v mat-dst) "lo2p0hsg.dst.log.rkt")
(exit 0)] [else (exit 1)])
