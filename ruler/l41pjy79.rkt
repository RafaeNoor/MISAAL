...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvlshr 'bvshl 'bvsgt 'if) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v2)))]
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "6_4zum8a.src.log.rkt")
(write-str-to-file (~v mat-dst) "6_4zum8a.dst.log.rkt")
(exit 0)] [else (exit 1)])
