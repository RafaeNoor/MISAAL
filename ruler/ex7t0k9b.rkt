...
;;                                Struct Definitions
;; ================================================================================
(struct typed:signed-vec-min (v0 v1 prec_i_o size_i_o) #:transparent #:mutable)
(struct hexagon_V6_vminuh_128B_dsl (v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8) #:transparent #:mutable)
(struct typed:unsigned-vec-min (v0 v1 prec_i_o size_i_o) #:transparent #:mutable)
(struct typed:unsigned-vec-sat-sub (v0 v1 prec_i_o size_i_o) #:transparent #:mutable)
;; ================================================================================
...
(define (double_target_:cost prog)
 (destruct prog
	...
	[ (typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		(+ cost_typed:signed-vec-min (double_target_:cost  v0)  (double_target_:cost  v1)  
		)
	]
	[ (hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(+ cost_hexagon_V6_vminuh_128B_dsl (double_target_:cost  v0)  (double_target_:cost  v1)  
		 
		)
	]
	[ (typed:unsigned-vec-min v0 v1 prec_i_o size_i_o)
		(+ cost_typed:unsigned-vec-min (double_target_:cost  v0)  (double_target_:cost  v1)  
		)
	]
	[ (typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o)
		(+ cost_typed:unsigned-vec-sat-sub (double_target_:cost  v0)  (double_target_:cost  v1)  
		)
	]
...
(define (double_target_:interpret prog env)
 (destruct prog
	...
	[ (typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		(do-typed:signed-min (double_target_:interpret v0 env) (double_target_:interpret v1 env) prec_i_o 
		 size_i_o)
	]
	[ (hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(hexagon_V6_vminuh_128B (double_target_:interpret v0 env) (double_target_:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 prec_i_o num_7 num_8)
	]
	[ (typed:unsigned-vec-min v0 v1 prec_i_o size_i_o)
		(do-typed:unsigned-min (double_target_:interpret v0 env) (double_target_:interpret v1 env) prec_i_o 
		 size_i_o)
	]
	[ (typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o)
		(do-typed:unsigned-sat-sub (double_target_:interpret v0 env) (double_target_:interpret v1 env) prec_i_o 
		 size_i_o)
	]
...
[(typed:signed-vec-min v0 v1 prec_i_o size_i_o) 
	(string-append "\n" 
	(string-append "(typed:signed-vec-min " (if (lit? v0) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v0 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v0 (vector 0)) (double_target_:get-prec v0 (vector 0))) (/ (double_target_:get-prec v0 (vector 0))) )] [else (values (/ (double_target_:get-length v0 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v0) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v0)) " " " " (if (lit? v1) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v1 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v1 (vector 0)) (double_target_:get-prec v1 (vector 0))) (/ (double_target_:get-prec v1 (vector 0))) )] [else (values (/ (double_target_:get-length v1 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v1) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v1)) " " " " (if (lit? prec_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length prec_i_o (vector 0)) (double_target_:get-prec prec_i_o (vector 0))) (/ (double_target_:get-prec prec_i_o (vector 0))) )] [else (values (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer prec_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer prec_i_o)) " " " " (if (lit? size_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length size_i_o (vector 0)) (double_target_:get-prec size_i_o (vector 0))) (/ (double_target_:get-prec size_i_o (vector 0))) )] [else (values (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer size_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer size_i_o)) " " " " ")")
	(string-append ";" "<" (~s (/ (double_target_:get-length prog (vector 0)) (double_target_:get-prec prog (vector 0))) ) " x " "i" (~s (double_target_:get-prec prog (vector 0))) ">") "\n")]
[(hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8) 
	(string-append "\n" 
	(string-append "(hexagon_V6_vminuh_128B_dsl " (if (lit? v0) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v0 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v0 (vector 0)) (double_target_:get-prec v0 (vector 0))) (/ (double_target_:get-prec v0 (vector 0))) )] [else (values (/ (double_target_:get-length v0 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v0) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v0)) " " " " (if (lit? v1) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v1 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v1 (vector 0)) (double_target_:get-prec v1 (vector 0))) (/ (double_target_:get-prec v1 (vector 0))) )] [else (values (/ (double_target_:get-length v1 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v1) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v1)) " " " " (if (lit? size_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length size_i_o (vector 0)) (double_target_:get-prec size_i_o (vector 0))) (/ (double_target_:get-prec size_i_o (vector 0))) )] [else (values (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer size_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer size_i_o)) " " " " (if (lit? num_3) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length num_3 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length num_3 (vector 0)) (double_target_:get-prec num_3 (vector 0))) (/ (double_target_:get-prec num_3 (vector 0))) )] [else (values (/ (double_target_:get-length num_3 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer num_3) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer num_3)) " " " " (if (lit? num_4) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length num_4 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length num_4 (vector 0)) (double_target_:get-prec num_4 (vector 0))) (/ (double_target_:get-prec num_4 (vector 0))) )] [else (values (/ (double_target_:get-length num_4 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer num_4) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer num_4)) " " " " (if (lit? num_5) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length num_5 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length num_5 (vector 0)) (double_target_:get-prec num_5 (vector 0))) (/ (double_target_:get-prec num_5 (vector 0))) )] [else (values (/ (double_target_:get-length num_5 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer num_5) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer num_5)) " " " " (if (lit? prec_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length prec_i_o (vector 0)) (double_target_:get-prec prec_i_o (vector 0))) (/ (double_target_:get-prec prec_i_o (vector 0))) )] [else (values (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer prec_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer prec_i_o)) " " " " (if (lit? num_7) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length num_7 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length num_7 (vector 0)) (double_target_:get-prec num_7 (vector 0))) (/ (double_target_:get-prec num_7 (vector 0))) )] [else (values (/ (double_target_:get-length num_7 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer num_7) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer num_7)) " " " " (if (lit? num_8) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length num_8 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length num_8 (vector 0)) (double_target_:get-prec num_8 (vector 0))) (/ (double_target_:get-prec num_8 (vector 0))) )] [else (values (/ (double_target_:get-length num_8 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer num_8) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer num_8)) " " " " ")")
	(string-append ";" "<" (~s (/ (double_target_:get-length prog (vector 0)) (double_target_:get-prec prog (vector 0))) ) " x " "i" (~s (double_target_:get-prec prog (vector 0))) ">") "\n")]
[(typed:unsigned-vec-min v0 v1 prec_i_o size_i_o) 
	(string-append "\n" 
	(string-append "(typed:unsigned-vec-min " (if (lit? v0) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v0 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v0 (vector 0)) (double_target_:get-prec v0 (vector 0))) (/ (double_target_:get-prec v0 (vector 0))) )] [else (values (/ (double_target_:get-length v0 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v0) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v0)) " " " " (if (lit? v1) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v1 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v1 (vector 0)) (double_target_:get-prec v1 (vector 0))) (/ (double_target_:get-prec v1 (vector 0))) )] [else (values (/ (double_target_:get-length v1 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v1) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v1)) " " " " (if (lit? prec_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length prec_i_o (vector 0)) (double_target_:get-prec prec_i_o (vector 0))) (/ (double_target_:get-prec prec_i_o (vector 0))) )] [else (values (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer prec_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer prec_i_o)) " " " " (if (lit? size_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length size_i_o (vector 0)) (double_target_:get-prec size_i_o (vector 0))) (/ (double_target_:get-prec size_i_o (vector 0))) )] [else (values (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer size_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer size_i_o)) " " " " ")")
	(string-append ";" "<" (~s (/ (double_target_:get-length prog (vector 0)) (double_target_:get-prec prog (vector 0))) ) " x " "i" (~s (double_target_:get-prec prog (vector 0))) ">") "\n")]
[(typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o) 
	(string-append "\n" 
	(string-append "(typed:unsigned-vec-sat-sub " (if (lit? v0) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v0 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v0 (vector 0)) (double_target_:get-prec v0 (vector 0))) (/ (double_target_:get-prec v0 (vector 0))) )] [else (values (/ (double_target_:get-length v0 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v0) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v0)) " " " " (if (lit? v1) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length v1 (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length v1 (vector 0)) (double_target_:get-prec v1 (vector 0))) (/ (double_target_:get-prec v1 (vector 0))) )] [else (values (/ (double_target_:get-length v1 (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer v1) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer v1)) " " " " (if (lit? prec_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length prec_i_o (vector 0)) (double_target_:get-prec prec_i_o (vector 0))) (/ (double_target_:get-prec prec_i_o (vector 0))) )] [else (values (/ (double_target_:get-length prec_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer prec_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer prec_i_o)) " " " " (if (lit? size_i_o) (begin (define-values (num_elem arg_prec) (cond [(< (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) 1)  (values  (/ (double_target_:get-length size_i_o (vector 0)) (double_target_:get-prec size_i_o (vector 0))) (/ (double_target_:get-prec size_i_o (vector 0))) )] [else (values (/ (double_target_:get-length size_i_o (vector 0)) prec_i_o) prec_i_o)]))(string-append (double_target_:hydride-printer size_i_o) " ; " "<" (~s num_elem) " x i" (~s arg_prec) ">" "\n" )) (double_target_:hydride-printer size_i_o)) " " " " ")")
	(string-append ";" "<" (~s (/ (double_target_:get-length prog (vector 0)) (double_target_:get-prec prog (vector 0))) ) " x " "i" (~s (double_target_:get-prec prog (vector 0))) ">") "\n")]
	[v (pretty-format v)]
 )
)
...
(define (double_target_:bind-expr prog env)
 (destruct prog
	...
	[ (typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		(typed:signed-vec-min (double_target_:bind-expr v0 env) (double_target_:bind-expr v1 env) (double_target_:bind-expr prec_i_o env) 
		 (double_target_:bind-expr size_i_o env))
	]
	[ (hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(hexagon_V6_vminuh_128B_dsl (double_target_:bind-expr v0 env) (double_target_:bind-expr v1 env) (double_target_:bind-expr size_i_o env) 
		 (double_target_:bind-expr num_3 env) (double_target_:bind-expr num_4 env) (double_target_:bind-expr num_5 env) 
		 (double_target_:bind-expr prec_i_o env) (double_target_:bind-expr num_7 env) (double_target_:bind-expr num_8 env))
	]
	[ (typed:unsigned-vec-min v0 v1 prec_i_o size_i_o)
		(typed:unsigned-vec-min (double_target_:bind-expr v0 env) (double_target_:bind-expr v1 env) (double_target_:bind-expr prec_i_o env) 
		 (double_target_:bind-expr size_i_o env))
	]
	[ (typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o)
		(typed:unsigned-vec-sat-sub (double_target_:bind-expr v0 env) (double_target_:bind-expr v1 env) (double_target_:bind-expr prec_i_o env) 
		 (double_target_:bind-expr size_i_o env))
	]
	[v v]
 )
...
(define (double_target_:visitor prog fn)
 (destruct prog
	...
	[ (typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		(define v0-visited (double_target_:visitor v0 fn))
		(define v1-visited (double_target_:visitor v1 fn))
		(fn ( typed:signed-vec-min v0-visited v1-visited prec_i_o size_i_o ))
	]
	[ (hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(define v0-visited (double_target_:visitor v0 fn))
		(define v1-visited (double_target_:visitor v1 fn))
	...
	[ (typed:unsigned-vec-min v0 v1 prec_i_o size_i_o)
		(define v0-visited (double_target_:visitor v0 fn))
		(define v1-visited (double_target_:visitor v1 fn))
		(fn ( typed:unsigned-vec-min v0-visited v1-visited prec_i_o size_i_o ))
	]
	[ (typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o)
		(define v0-visited (double_target_:visitor v0 fn))
		(define v1-visited (double_target_:visitor v1 fn))
		(fn ( typed:unsigned-vec-sat-sub v0-visited v1-visited prec_i_o size_i_o ))
	]
...
(define (double_target_:get-bv-ops prog)
 (destruct prog
	...
	[(lit v) '()]
		...
		[(llvm_shuffle_vectors_dsl v0 v1 num_2 prec_i_o v4 num_5)
		(remove-duplicates (append (list  'if 'bitvector->integer) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1) (double_target_:get-bv-ops v4)))
	]
		[(llvm-vect-add_dsl v0 v1 num_2 prec_i_o)
	...
	[(typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		(cond 
		[(and  (equal? prec_i_o 16) (equal? size_i_o 1024)); typed:signed-vec-min_p16_s1024_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 128)); typed:signed-vec-min_p16_s128_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 16)); typed:signed-vec-min_p16_s16_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 2048)); typed:signed-vec-min_p16_s2048_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 256)); typed:signed-vec-min_p16_s256_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 32)); typed:signed-vec-min_p16_s32_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 4096)); typed:signed-vec-min_p16_s4096_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 512)); typed:signed-vec-min_p16_s512_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 64)); typed:signed-vec-min_p16_s64_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 1024)); typed:signed-vec-min_p32_s1024_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 128)); typed:signed-vec-min_p32_s128_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 2048)); typed:signed-vec-min_p32_s2048_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 256)); typed:signed-vec-min_p32_s256_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 32)); typed:signed-vec-min_p32_s32_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 4096)); typed:signed-vec-min_p32_s4096_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 512)); typed:signed-vec-min_p32_s512_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 64)); typed:signed-vec-min_p32_s64_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 1024)); typed:signed-vec-min_p64_s1024_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 128)); typed:signed-vec-min_p64_s128_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 2048)); typed:signed-vec-min_p64_s2048_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 256)); typed:signed-vec-min_p64_s256_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 4096)); typed:signed-vec-min_p64_s4096_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 512)); typed:signed-vec-min_p64_s512_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 64)); typed:signed-vec-min_p64_s64_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 1024)); typed:signed-vec-min_p8_s1024_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 128)); typed:signed-vec-min_p8_s128_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 16)); typed:signed-vec-min_p8_s16_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 2048)); typed:signed-vec-min_p8_s2048_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 256)); typed:signed-vec-min_p8_s256_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 32)); typed:signed-vec-min_p8_s32_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 4096)); typed:signed-vec-min_p8_s4096_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 512)); typed:signed-vec-min_p8_s512_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 64)); typed:signed-vec-min_p8_s64_signed_1
 
  (remove-duplicates (append (list  'bvsmin 'bvslt 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 8)); typed:signed-vec-min_p8_s8_signed_1
  ...
  (remove-duplicates (append (list  'if 'bvult) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
  ...
  (remove-duplicates (append (list  'if 'bvslt) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
  ...
  (remove-duplicates (append (list  'if 'bvult) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
	...
	[(typed:unsigned-vec-min v0 v1 prec_i_o size_i_o)
		(cond 
		[(and  (equal? prec_i_o 16) (equal? size_i_o 1024)); typed:unsigned-vec-min_p16_s1024_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 128)); typed:unsigned-vec-min_p16_s128_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 16)); typed:unsigned-vec-min_p16_s16_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 2048)); typed:unsigned-vec-min_p16_s2048_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 256)); typed:unsigned-vec-min_p16_s256_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 32)); typed:unsigned-vec-min_p16_s32_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 4096)); typed:unsigned-vec-min_p16_s4096_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 512)); typed:unsigned-vec-min_p16_s512_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 64)); typed:unsigned-vec-min_p16_s64_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 1024)); typed:unsigned-vec-min_p32_s1024_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 128)); typed:unsigned-vec-min_p32_s128_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 2048)); typed:unsigned-vec-min_p32_s2048_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 256)); typed:unsigned-vec-min_p32_s256_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 32)); typed:unsigned-vec-min_p32_s32_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 4096)); typed:unsigned-vec-min_p32_s4096_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 512)); typed:unsigned-vec-min_p32_s512_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 64)); typed:unsigned-vec-min_p32_s64_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 1024)); typed:unsigned-vec-min_p64_s1024_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 128)); typed:unsigned-vec-min_p64_s128_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 2048)); typed:unsigned-vec-min_p64_s2048_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 256)); typed:unsigned-vec-min_p64_s256_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 4096)); typed:unsigned-vec-min_p64_s4096_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 512)); typed:unsigned-vec-min_p64_s512_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 64)); typed:unsigned-vec-min_p64_s64_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 1024)); typed:unsigned-vec-min_p8_s1024_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 128)); typed:unsigned-vec-min_p8_s128_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 16)); typed:unsigned-vec-min_p8_s16_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 2048)); typed:unsigned-vec-min_p8_s2048_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 256)); typed:unsigned-vec-min_p8_s256_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 32)); typed:unsigned-vec-min_p8_s32_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 4096)); typed:unsigned-vec-min_p8_s4096_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 512)); typed:unsigned-vec-min_p8_s512_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 64)); typed:unsigned-vec-min_p8_s64_signed_0
 
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 8)); typed:unsigned-vec-min_p8_s8_signed_0
  ...
  (remove-duplicates (append (list  'bvumin 'bvult 'extract) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
	...
	[(typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o)
		(cond 
		[(and  (equal? prec_i_o 16) (equal? size_i_o 1024)); typed:unsigned-vec-sat-sub_p16_s1024_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 128)); typed:unsigned-vec-sat-sub_p16_s128_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 16)); typed:unsigned-vec-sat-sub_p16_s16_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 2048)); typed:unsigned-vec-sat-sub_p16_s2048_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 256)); typed:unsigned-vec-sat-sub_p16_s256_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 32)); typed:unsigned-vec-sat-sub_p16_s32_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 4096)); typed:unsigned-vec-sat-sub_p16_s4096_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 512)); typed:unsigned-vec-sat-sub_p16_s512_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 16) (equal? size_i_o 64)); typed:unsigned-vec-sat-sub_p16_s64_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 1024)); typed:unsigned-vec-sat-sub_p32_s1024_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 128)); typed:unsigned-vec-sat-sub_p32_s128_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 2048)); typed:unsigned-vec-sat-sub_p32_s2048_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 256)); typed:unsigned-vec-sat-sub_p32_s256_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 32)); typed:unsigned-vec-sat-sub_p32_s32_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 4096)); typed:unsigned-vec-sat-sub_p32_s4096_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 512)); typed:unsigned-vec-sat-sub_p32_s512_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 32) (equal? size_i_o 64)); typed:unsigned-vec-sat-sub_p32_s64_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 1024)); typed:unsigned-vec-sat-sub_p64_s1024_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 128)); typed:unsigned-vec-sat-sub_p64_s128_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 2048)); typed:unsigned-vec-sat-sub_p64_s2048_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 256)); typed:unsigned-vec-sat-sub_p64_s256_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 4096)); typed:unsigned-vec-sat-sub_p64_s4096_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 512)); typed:unsigned-vec-sat-sub_p64_s512_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 64) (equal? size_i_o 64)); typed:unsigned-vec-sat-sub_p64_s64_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 1024)); typed:unsigned-vec-sat-sub_p8_s1024_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 128)); typed:unsigned-vec-sat-sub_p8_s128_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 16)); typed:unsigned-vec-sat-sub_p8_s16_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 2048)); typed:unsigned-vec-sat-sub_p8_s2048_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 256)); typed:unsigned-vec-sat-sub_p8_s256_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 32)); typed:unsigned-vec-sat-sub_p8_s32_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 4096)); typed:unsigned-vec-sat-sub_p8_s4096_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 512)); typed:unsigned-vec-sat-sub_p8_s512_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 64)); typed:unsigned-vec-sat-sub_p8_s64_signed_0
 
  (remove-duplicates (append (list  'bvsubnuw 'extract 'zero-extend) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v1)))]
		[(and  (equal? prec_i_o 8) (equal? size_i_o 8)); typed:unsigned-vec-sat-sub_p8_s8_signed_0
...
(lit (double_target_:interpret ( scalar_splat_dsl v0-folded size_i size_o ) (vector)))
	...
	[ (typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (double_target_:interpret ( typed:signed-vec-min v0-folded v1-folded prec_i_o size_i_o ) (vector)))
]
		[else ( typed:signed-vec-min v0-folded v1-folded prec_i_o size_i_o )]
		)
	]
	[ (hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(define v0-folded (double_target_:const-fold v0))
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (double_target_:interpret ( hexagon_V6_vminuh_128B_dsl v0-folded v1-folded size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) (vector)))
]
	...
	[ (typed:unsigned-vec-min v0 v1 prec_i_o size_i_o)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (double_target_:interpret ( typed:unsigned-vec-min v0-folded v1-folded prec_i_o size_i_o ) (vector)))
]
		[else ( typed:unsigned-vec-min v0-folded v1-folded prec_i_o size_i_o )]
		)
	]
	[ (typed:unsigned-vec-sat-sub v0 v1 prec_i_o size_i_o)
		(define v0-folded (double_target_:const-fold v0))
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (double_target_:interpret ( typed:unsigned-vec-sat-sub v0-folded v1-folded prec_i_o size_i_o ) (vector)))
]
		[else ( typed:unsigned-vec-sat-sub v0-folded v1-folded prec_i_o size_i_o )]
		)
	]
...
(lit (double_target_:interpret ( typed:signed-vec-min v0-folded v1-folded prec_i_o size_i_o ) (vector)))
		...
		[(lit? v0-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (typed:signed-vec-min v0-folded (reg (bv 0 4)) prec_i_o size_i_o))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v1-folded]
[else ( typed:signed-vec-min v0-folded v1-folded prec_i_o size_i_o )])
		...
		[(lit? v1-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (typed:signed-vec-min (reg (bv 0 4)) v1-folded prec_i_o size_i_o))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v0-folded]
[else ( typed:signed-vec-min v0-folded v1-folded prec_i_o size_i_o )])
...
(lit (double_target_:interpret ( hexagon_V6_vminuh_128B_dsl v0-folded v1-folded size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) (vector)))
		...
		[(lit? v0-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (hexagon_V6_vminuh_128B_dsl v0-folded (reg (bv 0 4)) size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v1-folded]
[else ( hexagon_V6_vminuh_128B_dsl v0-folded v1-folded size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 )])
		...
		[(lit? v1-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (hexagon_V6_vminuh_128B_dsl (reg (bv 0 4)) v1-folded size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v0-folded]
[else ( hexagon_V6_vminuh_128B_dsl v0-folded v1-folded size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 )])
...
(lit (double_target_:interpret ( typed:unsigned-vec-min v0-folded v1-folded prec_i_o size_i_o ) (vector)))
		...
		[(lit? v0-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (typed:unsigned-vec-min v0-folded (reg (bv 0 4)) prec_i_o size_i_o))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v1-folded]
[else ( typed:unsigned-vec-min v0-folded v1-folded prec_i_o size_i_o )])
		...
		[(lit? v1-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (typed:unsigned-vec-min (reg (bv 0 4)) v1-folded prec_i_o size_i_o))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v0-folded]
[else ( typed:unsigned-vec-min v0-folded v1-folded prec_i_o size_i_o )])
...
(lit (double_target_:interpret ( typed:unsigned-vec-sat-sub v0-folded v1-folded prec_i_o size_i_o ) (vector)))
		...
		[(lit? v0-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (typed:unsigned-vec-sat-sub v0-folded (reg (bv 0 4)) prec_i_o size_i_o))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v1-folded]
[else ( typed:unsigned-vec-sat-sub v0-folded v1-folded prec_i_o size_i_o )])
		...
		[(lit? v1-folded)
(define test-env (vector (?? (bitvector size_i_o))))
(define test-expr (typed:unsigned-vec-sat-sub (reg (bv 0 4)) v1-folded prec_i_o size_i_o))
(define test-result (double_target_:interpret test-expr test-env))
(cond [(concrete? test-result) (lit test-result)]
[(equal? test-result (vector-ref test-env 0))  v0-folded]
[else ( typed:unsigned-vec-sat-sub v0-folded v1-folded prec_i_o size_i_o )])
...
;; ================================================================================
;;                                DSL Contains Reg Def
;; ================================================================================
(define (contains_reg prog reg_idx)
 (destruct prog
	[(lit v) #f ]
	[(reg id) (cond [(bv? id) (equal? (bitvector->natural id)  reg_idx) ] [else (equal? id  reg_idx)]) ]
	[(buffer-index id type size) (cond [(bv? id) (equal? (bitvector->natural id)  reg_idx) ] [else (equal? id  reg_idx)]) ]
	[ (typed:signed-vec-min v0 v1 prec_i_o size_i_o)
		(or (contains_reg v0 reg_idx)
(contains_reg v1 reg_idx))
	]
	[ (hexagon_V6_vminuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(or (contains_reg v0 reg_idx)
(contains_reg v1 reg_idx))
...
(contains_reg v1 reg_idx))
	...
	[v  (error "Unrecognized Term in contain reg" v)]
 )
)
;; ================================================================================

(define (src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024) 
(choose* 
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminuh_128B
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_0_hexagon_V6_vminuh_128B_layer_1_bv_1024)
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_1_hexagon_V6_vminuh_128B_layer_1_bv_1024)
...
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminw_128B
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_0_hexagon_V6_vminuh_128B_layer_1_bv_1024)
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_1_hexagon_V6_vminuh_128B_layer_1_bv_1024)
1024				;; Integer Operand 
1024				;; Integer Operand 
...
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminb_128B
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_0_hexagon_V6_vminuh_128B_layer_1_bv_1024)
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_1_hexagon_V6_vminuh_128B_layer_1_bv_1024)
1024				;; Integer Operand 
1024				;; Integer Operand 
...
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminh_128B
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_0_hexagon_V6_vminuh_128B_layer_1_bv_1024)
(src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_1_hexagon_V6_vminuh_128B_layer_1_bv_1024)
1024				;; Integer Operand 
1024				;; Integer Operand 
...
(define (src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_0_hexagon_V6_vminuh_128B_layer_1_bv_1024) 
(choose* 
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminuh_128B
...
(define (src_src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024_arg_1_hexagon_V6_vminuh_128B_layer_1_bv_1024) 
(choose* 
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminuh_128B
(choose* (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))))
1024				;; Integer Operand 
1024				;; Integer Operand 
0				;; Integer Operand 
...
(define src-expr
 (src_output_hexagon_V6_vminuh_128B_layer_0_bv_1024)
)
(define (dst_output_typed:unsigned-vec-sat-sub_layer_0_bv_1024) 
(choose* 
(typed:unsigned-vec-sat-sub	;typed:unsigned-vec-sat-sub_p16_s1024_signed_0
(dst_dst_output_typed:unsigned-vec-sat-sub_layer_0_bv_1024_arg_0_typed:signed-vec-min_layer_1_bv_1024)
(dst_dst_output_typed:unsigned-vec-sat-sub_layer_0_bv_1024_arg_1_typed:unsigned-vec-min_layer_1_bv_1024)
16				;; Precision Operand 
1024				;; Integer Operand 
)
...
(define (dst_dst_output_typed:unsigned-vec-sat-sub_layer_0_bv_1024_arg_0_typed:signed-vec-min_layer_1_bv_1024) 
(choose* 
...
(define (dst_dst_output_typed:unsigned-vec-sat-sub_layer_0_bv_1024_arg_1_typed:unsigned-vec-min_layer_1_bv_1024) 
(choose* 
...
(define (invoke-spec src-expr  env)
 (cond [(not (concrete? src-expr)) (assert (and (contains_reg src-expr 0) (contains_reg src-expr 1)))])
(double_target_:interpret src-expr env))
(define (invoke-spec-lane src-expr lane-idx env)
 (cond [(not (concrete? src-expr)) (assert (and (contains_reg src-expr 0) (contains_reg src-expr 1)))])
(define low (* 16 lane-idx))
...
(define leaves-sizes (list 1024 1024))
(define-values (satisfiable? mat-src mat-dst)  (expanded-grammar-synthesize invoke-spec invoke-spec-lane src-expr (dst_output_typed:unsigned-vec-sat-sub_layer_0_bv_1024) leaves-sizes optimize? interpreter cost-model  symbolic? 30 'z3))
(cond [satisfiable? (write-str-to-file (~v mat-src) "m_qa27jz.src.log.rkt")
(write-str-to-file (~v mat-dst) "m_qa27jz.dst.log.rkt")
(exit 0)] [else (exit 1)])
