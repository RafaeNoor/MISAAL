...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvshl 'bvsgt 'bvlshr 'if) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v2)))]
...
(dst_dst_output_typed:unsigned-vec-div_layer_0_bv_1024_arg_0_typed:unsigned-vec-shr_layer_1_bv_1024)
(choose* (reg  (bv 0 (bitvector 8))))
16				;; Precision Operand 
1024				;; Integer Operand 
)
...
(define (dst_dst_output_typed:unsigned-vec-div_layer_0_bv_1024_arg_0_typed:unsigned-vec-shr_layer_1_bv_1024) 
(choose* 
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "_odboti7.src.log.rkt")
(write-str-to-file (~v mat-dst) "_odboti7.dst.log.rkt")
(exit 0)] [else (exit 1)])
