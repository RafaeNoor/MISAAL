...
(choose* 
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminuh_128B
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))))
1024				;; Integer Operand 
1024				;; Integer Operand 
0				;; Integer Operand 
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "tsebnbj7.src.log.rkt")
(write-str-to-file (~v mat-dst) "tsebnbj7.dst.log.rkt")
(exit 0)] [else (exit 1)])
