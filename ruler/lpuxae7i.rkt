...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvlshr 'bvshl 'if 'bvsgt) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v2)))]
...
(contains_reg vc_1 reg_idx)
(contains_reg v2 reg_idx))
	]
	[ (typed:unsigned-vec-shr v0 v1 prec_i_o size_i_o)
		(or (contains_reg v0 reg_idx)
...
(src_src_output_hexagon_V6_vlsrwv_128B_layer_0_bv_1024_arg_0_hexagon_V6_vlsrwv_128B_layer_1_bv_1024)
(lit (bv #x00000000000000000000000000000000 (bitvector 32)))				;; 32-bit Constant Bitvector operand
(src_src_output_hexagon_V6_vlsrwv_128B_layer_0_bv_1024_arg_2_hexagon_V6_vlsrwv_128B_layer_1_bv_1024)
...
(define (src_src_output_hexagon_V6_vlsrwv_128B_layer_0_bv_1024_arg_0_hexagon_V6_vlsrwv_128B_layer_1_bv_1024) 
(choose* 
(hexagon_V6_vlsrwv_128B_dsl	;hexagon_V6_vlsrwv_128B
...
(define (src_src_output_hexagon_V6_vlsrwv_128B_layer_0_bv_1024_arg_2_hexagon_V6_vlsrwv_128B_layer_1_bv_1024) 
(choose* 
(hexagon_V6_vlsrwv_128B_dsl	;hexagon_V6_vlsrwv_128B
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
(lit (bv #x00000000000000000000000000000000 (bitvector 32)))				;; 32-bit Constant Bitvector operand
...
(dst_dst_output_typed:unsigned-vec-shr_layer_0_bv_1024_arg_0_typed:unsigned-vec-shr_layer_1_bv_1024)
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
16				;; Precision Operand 
1024				;; Integer Operand 
)
...
(define (dst_dst_output_typed:unsigned-vec-shr_layer_0_bv_1024_arg_0_typed:unsigned-vec-shr_layer_1_bv_1024) 
(choose* 
(typed:unsigned-vec-shr	;typed:unsigned-vec-shr_p16_s1024_signed_0
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
...
(define (invoke-spec src-expr  env)
 (cond [(not (concrete? src-expr)) (assert (and (contains_reg src-expr 0) (contains_reg src-expr 1) (contains_reg src-expr 2)))])
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "n1am0efz.src.log.rkt")
(write-str-to-file (~v mat-dst) "n1am0efz.dst.log.rkt")
(exit 0)] [else (exit 1)])
