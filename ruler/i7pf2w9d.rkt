...
(choose* 
(hexagon_V6_vminuh_128B_dsl	;hexagon_V6_vminuh_128B
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
1024				;; Integer Operand 
1024				;; Integer Operand 
0				;; Integer Operand 
...
(define (dst_output_typed:unsigned-vec-min_layer_0_bv_1024) 
(choose* 
(typed:unsigned-vec-min	;typed:unsigned-vec-min_p16_s1024_signed_0
(dst_dst_output_typed:unsigned-vec-min_layer_0_bv_1024_arg_0_typed:unsigned-vec-min_layer_1_bv_1024)
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
16				;; Precision Operand 
1024				;; Integer Operand 
)
...
(define (dst_dst_output_typed:unsigned-vec-min_layer_0_bv_1024_arg_0_typed:unsigned-vec-min_layer_1_bv_1024) 
(choose* 
(typed:unsigned-vec-min	;typed:unsigned-vec-min_p16_s1024_signed_0
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))) (reg  (bv 1 (bitvector 8))) (reg  (bv 2 (bitvector 8))))
...
(define leaves-sizes (list 1024 1024 1024))
(define-values (satisfiable? mat-src mat-dst)  (expanded-grammar-synthesize invoke-spec invoke-spec-lane src-expr (dst_output_typed:unsigned-vec-min_layer_0_bv_1024) leaves-sizes optimize? interpreter cost-model  symbolic? 30 'z3))
(cond [satisfiable? (write-str-to-file (~v mat-src) "wru89jxh.src.log.rkt")
(write-str-to-file (~v mat-dst) "wru89jxh.dst.log.rkt")
(exit 0)] [else (exit 1)])
