...
(define (dst_output_typed:unsigned-vec-div_layer_0_bv_1024) 
(choose* 
(typed:unsigned-vec-div	;typed:unsigned-vec-div_p16_s1024_signed_0
(dst_dst_output_typed:unsigned-vec-div_layer_0_bv_1024_arg_0_typed:unsigned-vec-div_layer_1_bv_1024)
(choose* (reg  (bv 0 (bitvector 8))))
16				;; Precision Operand 
1024				;; Integer Operand 
)
...
(define (dst_dst_output_typed:unsigned-vec-div_layer_0_bv_1024_arg_0_typed:unsigned-vec-div_layer_1_bv_1024) 
(choose* 
(typed:unsigned-vec-div	;typed:unsigned-vec-div_p16_s1024_signed_0
(choose* (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 1 (bitvector 8))))
...
(define-values (satisfiable? mat-src mat-dst)  (expanded-grammar-synthesize invoke-spec invoke-spec-lane src-expr (dst_output_typed:unsigned-vec-div_layer_0_bv_1024) leaves-sizes optimize? interpreter cost-model  symbolic? 30 'z3))
(cond [satisfiable? (write-str-to-file (~v mat-src) "66on0mdr.src.log.rkt")
(write-str-to-file (~v mat-dst) "66on0mdr.dst.log.rkt")
(exit 0)] [else (exit 1)])
