...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvsgt 'bvlshr 'if 'bvshl) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v2)))]
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "i3yb7hgl.src.log.rkt")
(write-str-to-file (~v mat-dst) "i3yb7hgl.dst.log.rkt")
(exit 0)] [else (exit 1)])
