...
(define (double_target_:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvlshr 'bvsgt 'if 'bvshl) (double_target_:get-bv-ops v0) (double_target_:get-bv-ops v2)))]
...
(choose* (reg  (bv 1 (bitvector 8))))
(dst_dst_output_typed:unsigned-vec-shr_layer_0_bv_1024_arg_1_typed:unsigned-vec-shr_layer_1_bv_1024)
16				;; Precision Operand 
1024				;; Integer Operand 
)
...
(define (dst_dst_output_typed:unsigned-vec-shr_layer_0_bv_1024_arg_1_typed:unsigned-vec-shr_layer_1_bv_1024) 
(choose* 
(typed:unsigned-vec-shr	;typed:unsigned-vec-shr_p16_s1024_signed_0
(choose* (reg  (bv 1 (bitvector 8))))
(choose* (reg  (bv 0 (bitvector 8))))
...
(cond [satisfiable? (write-str-to-file (~v mat-src) "ljtx3rtf.src.log.rkt")
(write-str-to-file (~v mat-dst) "ljtx3rtf.dst.log.rkt")
(exit 0)] [else (exit 1)])
