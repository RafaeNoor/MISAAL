...
so_path = "/u/is16/526/Hydride/codegen-generator/tools/low-level-codegen/build/libX86LegalizerAllArgs.so"
...
misaal_compiler = HydrideCompiler(misaal_patterns, src_dsl_list = misaal_input, target_dsl_list = misaal_output, run_iterations = 5, egg_pkg_path = EGG_PKG_PATH, tests = tests, llvm_so_path = so_path, llvm_flags =  llvm_flags, intrinsics_file =  intrin, hydride_root_path =  HYDRIDE_ROOT, llvm_out_file_name = "/u/is16/526/MISAAL/test/tvm/misaal_tests/test_cases/test_vec_div_misaal_temp_file")
