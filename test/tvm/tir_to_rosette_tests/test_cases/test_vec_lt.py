...
def test_simple_vec_lt():
    @I.ir_module
    class Module:
        @T.prim_func(private=True)
        def vec_add(x: T.Buffer((T.int64(1), T.int64(128)), "int32"), y: T.Buffer((T.int64(1), T.int64(128)), "int32"), T_add_intermediate_1: T.Buffer((T.int64(1), T.int64(128)), "bool")):
            ...
            for ax0_ax1_fused_0_ax0_ax1_fused_1_fused_0 in T.parallel(T.int64(2)):
                for ax0_ax1_fused_0_ax0_ax1_fused_1_fused_1 in T.vectorized(T.int64(64)):
                    with T.block("T_add_1"):
                        ...
                        T_add_intermediate_1[v_ax0, v_ax1] = T.LT(x[v_ax0, v_ax1], y[v_ax0, v_ax1])

        @R.function
        def forward(x: R.Tensor((1, 128), dtype="int32"), y: R.Tensor((1, 128), dtype="int32")) -> R.Tensor((1, 128), dtype="bool"):
