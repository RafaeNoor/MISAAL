...
hydride_compiler = HydrideCompiler([pattern], src_dsl_list = halide_dsl_list, target_dsl_list = hvx_dsl_list, run_iterations = 1,  egg_pkg_path = EGG_PKG_PATH, function_name = "hydride.node.test_func", tests = tests,
