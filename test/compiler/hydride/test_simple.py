...
hydride_compiler = HydrideCompiler([pattern], src_dsl_list = halide_dsl_list, target_dsl_list = hvx_dsl_list, run_iterations = 1, egg_file_name = f"{current_file_base}.egg", egg_pkg_path = EGG_PKG_PATH, function_name = "test_func", input_file_path = src_expr_file_path, output_file_path = output_file_path )
