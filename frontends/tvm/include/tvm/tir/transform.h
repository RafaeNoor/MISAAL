...
/*!
 * \brief Extracts vectorized computation and passes it to MISAAL. 
 *       Replace extracted code with a call to an external function to be linked in later.
 *
 * \return The pass.
 */
TVM_DLL Pass InjectMisaal();
