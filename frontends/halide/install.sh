...
# LLVM Commit with cstdint.h fix: ff1681ddb303223973653f7f5f3f3435b48a1983
...
cmake -G Ninja -S $LLVM_SRC -B $BUILD_DIR -DCMAKE_BUILD_TYPE=Release -DLLVM_ENABLE_PROJECTS="clang;lld;clang-tools-extra" -DLLVM_TARGETS_TO_BUILD="X86;ARM;NVPTX;AArch64;Mips;Hexagon;WebAssembly" -DLLVM_ENABLE_TERMINFO=OFF -DLLVM_ENABLE_ASSERTIONS=ON -DLLVM_ENABLE_EH=ON -DLLVM_ENABLE_RTTI=ON -DLLVM_BUILD_32_BITS=OFF -DLLVM_INCLUDE_BENCHMARKS=Off 
