...
(define (typed:halide:get-length prog env)
 (destruct prog
	...
	[(typed:cast-int v0 prec_i num_2 num_3 prec_o)
		(cond 
		[(and  (equal? prec_i 16) (equal? num_2 0) (equal? num_3 64) (equal? prec_o 32)) 2048]
		[(and  (equal? prec_i 16) (equal? num_2 0) (equal? num_3 128) (equal? prec_o 8)) 1024]
		[(and  (equal? prec_i 32) (equal? num_2 0) (equal? num_3 64) (equal? prec_o 16)) 1024]
		[(and  (equal? prec_i 8) (equal? num_2 0) (equal? num_3 128) (equal? prec_o 16)) 2048]
		[(and  (equal? prec_i 16) (equal? num_2 1) (equal? num_3 64) (equal? prec_o 32)) 2048]
		[(and  (equal? prec_i 16) (equal? num_2 1) (equal? num_3 128) (equal? prec_o 8)) 1024]
		[(and  (equal? prec_i 32) (equal? num_2 1) (equal? num_3 64) (equal? prec_o 16)) 1024]
		[(and  (equal? prec_i 8) (equal? num_2 1) (equal? num_3 128) (equal? prec_o 16)) 2048]
	...
	[(typed:signed-vec-abs v0 num_1 prec_i_o)
		(cond 
		[(and  (equal? num_1 16) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_1 16) (equal? prec_i_o 2048)) 2048]
		[(and  (equal? num_1 32) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_1 32) (equal? prec_i_o 2048)) 2048]
		[(and  (equal? num_1 8) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_1 8) (equal? prec_i_o 2048)) 2048]
	...
	[(typed:signed-vec-absd v0 v1 num_2 prec_i_o)
		(cond 
		[(and  (equal? num_2 16) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_2 16) (equal? prec_i_o 2048)) 2048]
		[(and  (equal? num_2 32) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_2 32) (equal? prec_i_o 2048)) 2048]
		[(and  (equal? num_2 8) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_2 8) (equal? prec_i_o 2048)) 2048]
	...
	[(typed:signed-vec-rounding_mul_shift_right v0 v1 v2 num_3 prec_i_o)
		(cond 
		[(and  (equal? num_3 16) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_3 16) (equal? prec_i_o 2048)) 2048]
		[(and  (equal? num_3 32) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_3 32) (equal? prec_i_o 2048)) 2048]
		[(and  (equal? num_3 8) (equal? prec_i_o 1024)) 1024]
		[(and  (equal? num_3 8) (equal? prec_i_o 2048)) 2048]
